...
import bookings.domain.Payment;
import bookings.repository.PaymentRepository;
...
/**
 * REST controller for managing {@link bookings.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PaymentResource {
    ...
    private static final String ENTITY_NAME = "bookingsPayment";
