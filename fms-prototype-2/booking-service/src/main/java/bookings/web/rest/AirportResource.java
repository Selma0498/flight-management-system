...
import bookings.domain.Airport;
import bookings.repository.AirportRepository;
...
/**
 * REST controller for managing {@link bookings.domain.Airport}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AirportResource {
    ...
    private static final String ENTITY_NAME = "bookingsAirport";
