...
import bookings.repository.PlaneRepository;
...
/**
 * REST controller for managing {@link bookings.domain.Plane}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PlaneResource {
    ...
    private static final String ENTITY_NAME = "bookingsPlane";
