...
import bookings.domain.CreditCard;
import bookings.repository.CreditCardRepository;
...
/**
 * REST controller for managing {@link bookings.domain.CreditCard}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CreditCardResource {
    ...
    private static final String ENTITY_NAME = "bookingsCreditCard";
    ...
    public ResponseEntity<CreditCard> updateCreditCard(@Valid @RequestBody CreditCard creditCard) throws URISyntaxException {
