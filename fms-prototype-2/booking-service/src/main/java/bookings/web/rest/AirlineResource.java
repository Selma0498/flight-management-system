...
import bookings.repository.AirlineRepository;
...
/**
 * REST controller for managing {@link bookings.domain.Airline}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AirlineResource {
    ...
    private static final String ENTITY_NAME = "bookingsAirline";
