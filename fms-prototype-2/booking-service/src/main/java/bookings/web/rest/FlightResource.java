...
import bookings.repository.FlightRepository;
...
/**
 * REST controller for managing {@link bookings.domain.Flight}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class FlightResource {
    ...
    private static final String ENTITY_NAME = "bookingsFlight";
