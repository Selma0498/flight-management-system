...
import flights.domain.Payment;
import flights.repository.PaymentRepository;
...
/**
 * REST controller for managing {@link flights.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PaymentResource {
    ...
    private static final String ENTITY_NAME = "flightsPayment";
