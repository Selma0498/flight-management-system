...
import flights.domain.Passenger;
import flights.repository.PassengerRepository;
...
/**
 * REST controller for managing {@link flights.domain.Passenger}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PassengerResource {
    ...
    private static final String ENTITY_NAME = "flightsPassenger";
