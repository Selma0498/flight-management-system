...
class PaymentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Payment entity")
        ...
        .repeat(2) {
            ...
            .get("/services/passengers/api/payments")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new payment")
            .post("/services/passengers/api/payments")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/passengers${new_payment_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created payment")
            .delete("/services/passengers${new_payment_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
