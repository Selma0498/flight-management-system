...
@RestController
@RequestMapping("/api/luggagemanagement-kafka")
public class LuggagemanagementKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LuggagemanagementKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LuggagemanagementKafkaResource(KafkaProperties kafkaProperties) {
